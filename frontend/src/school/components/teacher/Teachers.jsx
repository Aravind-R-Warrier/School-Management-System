  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {edit? <Typography variant={'h4'} sx={{textAlign:'center',margin:'0',padding:'0',fontWeight:'800',fontFamily:'New Courier'}}>Edit Teacher</Typography>:
                     <Typography variant={'h4'} sx={{textAlign:'center',margin:'0',padding:'0',fontWeight:'800',fontFamily:'New Courier'}}>Add Teacher</Typography>
     }

          <Typography variant="p">Add Teacher Picture</Typography>
          <TextField
            type="file"
